...
let dropdownNavMenu = document.querySelector(".dropdownNavMenu");
menuMobileButton.addEventListener("click", ()=>{
    dropdownNavMenu.classList.toggle("deployed");
});
